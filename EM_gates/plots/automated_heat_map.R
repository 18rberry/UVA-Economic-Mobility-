...
Dimensions<-rep(c("Early Childhood Education", "Post-Secondary Affordability Policy", "School Climate", "Workforce Development Policy"), c(3*21, 3*10, 3*34, 3*8)) #3=number of states*number of dimension questions
...
Questions <- factor(education$'"POLICY QUESTIONS"')
...
#Reading in scores :)
# Vatsala
Scores<-ifelse(education$score==1,"Yes", "No")
