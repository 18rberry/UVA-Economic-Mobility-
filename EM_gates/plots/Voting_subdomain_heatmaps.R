...
png("vote_heat_access.png", width = 700, height = 400)
heatmap.for.subdomain("Voting", "Accessibility", access_scores)
dev.off()


png("vote_heat_registration.png", width = 1000, height = 350)
heatmap.for.subdomain("Voting", "Registration", registration_scores)
dev.off()
