...
server <- function(input, output, session) {
  ...
  #edu_3states <- read_csv("~/git/dspg20uvaEM/EM_gates/cesar_code/edu_3states.csv")
  ...
  edu_av2<-read_csv("~/git/dspg20uvaEM/EM_gates/cesar_code/edu_av2.csv")
  
  
  source("~/git/dspg20uvaEM/EM_gates/cesar_code/R_rainclouds.R")
  source("~/git/dspg20uvaEM/EM_gates/cesar_code/summarySE.R")
  source("~/git/dspg20uvaEM/EM_gates/cesar_code/simulateData.R")
